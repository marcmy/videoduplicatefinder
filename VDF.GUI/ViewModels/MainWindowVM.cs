	...
	public partial class MainWindowVM : ReactiveObject {
		...
		public MainWindowVM() {
			...
			SortOrders = new SortOrderOption[] {
				...
				new SortOrderOption("Path Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Path)}", ListSortDirection.Ascending)),
				new SortOrderOption("Path Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Path)}", ListSortDirection.Descending)),
				...
				new SortOrderOption("Format Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Format)}", ListSortDirection.Ascending)),
				new SortOrderOption("Format Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Format)}", ListSortDirection.Descending)),
				new SortOrderOption("FPS Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Fps)}", ListSortDirection.Ascending)),
				new SortOrderOption("FPS Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.Fps)}", ListSortDirection.Descending)),
				new SortOrderOption("Video Bitrate Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.BitRateKbs)}", ListSortDirection.Ascending)),
				new SortOrderOption("Video Bitrate Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.BitRateKbs)}", ListSortDirection.Descending)),
				new SortOrderOption("HDR Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.HdrFormatRank)}", ListSortDirection.Ascending)),
				new SortOrderOption("HDR Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.HdrFormatRank)}", ListSortDirection.Descending)),
				new SortOrderOption("Audio Format Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioFormat)}", ListSortDirection.Ascending)),
				new SortOrderOption("Audio Format Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioFormat)}", ListSortDirection.Descending)),
				new SortOrderOption("Audio Channels Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioChannel)}", ListSortDirection.Ascending)),
				new SortOrderOption("Audio Channels Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioChannel)}", ListSortDirection.Descending)),
				new SortOrderOption("Audio Sample Rate Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioSampleRate)}", ListSortDirection.Ascending)),
				new SortOrderOption("Audio Sample Rate Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioSampleRate)}", ListSortDirection.Descending)),
				new SortOrderOption("Audio Bitrate Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioBitRateKbs)}", ListSortDirection.Ascending)),
				new SortOrderOption("Audio Bitrate Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.AudioBitRateKbs)}", ListSortDirection.Descending)),
				...
				new SortOrderOption("Clip Offset Ascending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.PartialClipOffset)}", ListSortDirection.Ascending)),
				new SortOrderOption("Clip Offset Descending",
				DataGridSortDescription.FromPath($"{nameof(DuplicateItemVM.ItemInfo)}.{nameof(DuplicateItem.PartialClipOffset)}", ListSortDirection.Descending)),
